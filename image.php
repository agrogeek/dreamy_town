...
?>
	...
	?>
			<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				<header class="entry-header">
					...
					<div class="entry-meta">
						...
						<?php edit_post_link( __( 'Edit', 'dreamy_town' ), '<span class="edit-link">', '</span>' ); ?>
					</div><!-- .entry-meta -->
				</header><!-- .entry-header -->
				...
				<div class="entry-content">
					<div class="entry-attachment">
						<div class="attachment">
							<?php dreamy_town_the_attached_image(); ?>
						</div><!-- .attachment -->
			...
			<nav id="image-navigation" class="navigation image-navigation">
				<div class="nav-links">
				<?php previous_image_link( false, '<div class="previous-image">' . __( 'Previous Image', 'dreamy_town' ) . '</div>' ); ?>
				<?php next_image_link( false, '<div class="next-image">' . __( 'Next Image', 'dreamy_town' ) . '</div>' ); ?>
				</div><!-- .nav-links -->
